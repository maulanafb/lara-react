        ...
        <>
            ...
            {!isPremium && (
                <div
                    ...
                    <div onClick={onSelectSubscription}>
                        <CButton type="button" variant="white-outline" className="rounded-2xl border border-[#f1f1f1] py-[13px] text-center grid">
            ...
            {isPremium && (
                <div
                    ...
                    <div onClick={onSelectSubscription}>
                        <CButton type="button" href="payment_status/success.html"
